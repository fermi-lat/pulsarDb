...
TTYPE10      = 'TOABARY_INT'               / integer part of infinite-frequency binary-demodulated, barycentric pulse arrival time (TDB) in MJD
TFORM10      = 'J'                         / data format of field: 4-byte signed INTEGER
TUNIT10      = 'd'                         / physical unit of field
TTYPE11      = 'TOABARY_FRAC'              / fractional part of infinite-frequency binary-demodulated, barycentric pulse arrival time (TDB) in MJD
